...
public class Leitor
{
    ...
    private static final String VALOR_NAO_PERTENCE  = "O valor não pertence a um dos valores aceitos" + NEW_LINE;
    private static final String DIGITE_NOVAMENTE    = "Digite novamente..." + NEW_LINE;
    ...
    public static byte readByte(String pPrompt, long pValor)
    {
        while (true)
        {
            ...
            {
                printPrompt(VALOR_INVALIDO + TIPO_BYTE + NEW_LINE);
    ...
    public static short readShort(String pPrompt, long pValor)
    {
        while (true)
        {
            ...
            {
                printPrompt(VALOR_INVALIDO + TIPO_SHORT + NEW_LINE);
                printPrompt(DIGITE_NOVAMENTE);
            }
        }
    }
    ...
    public static int readInt(String pPrompt, long pValor)
    {
        while (true)
        {
            ...
            {
                printPrompt(VALOR_INVALIDO + TIPO_INT + NEW_LINE);
                printPrompt(DIGITE_NOVAMENTE);
            }
        }
    }
    ...
    public static long readLong(String pPrompt, long pValor)
    {
        ...
        while (true)
        {
            ...
            {
                printPrompt(VALOR_INVALIDO + TIPO_LONG + NEW_LINE);
                printPrompt(DIGITE_NOVAMENTE);
            }
        }
    }
    ...
    public static float readFloat(String pPrompt, double pValor)
    {
        while (true)
        {
            ...
            {
                printPrompt(VALOR_INVALIDO + TIPO_FLOAT + NEW_LINE);
                printPrompt(DIGITE_NOVAMENTE);
            }
        }
    }
    ...
    public static double readDouble(String pPrompt, double pValor)
    {
        while (true)
        {
            ...
            {
                printPrompt(VALOR_INVALIDO + TIPO_DOUBLE + NEW_LINE);
                printPrompt(DIGITE_NOVAMENTE);
            }
        }
    }
    ...
    public static boolean readBoolean(String pPrompt, boolean pValor)
    {
        while (true)
        {
            ...
            if ("false".equalsIgnoreCase(tLinha) || "f".equalsIgnoreCase(tLinha))
                return false;
            printPrompt(VALOR_INVALIDO + TIPO_BOOLEAN + NEW_LINE);
            printPrompt(DIGITE_NOVAMENTE);
        }
    }
    ...
    public static BigDecimal readBigDecimal(String pPrompt, BigDecimal pValor)
    {
        while (true)
        {
            ...
            {
                printPrompt(VALOR_INVALIDO + TIPO_BIGDECIMAL + NEW_LINE);
                printPrompt(DIGITE_NOVAMENTE);
            }
        }
    }
    ...
    public static Date readDate(String pPrompt, Date pValor, String pFormato)
    {
        ...
        while (true)
        {
            ...
            {
                printPrompt(VALOR_INVALIDO + TIPO_DATE + NEW_LINE);
                printPrompt(DIGITE_NOVAMENTE);
            }
        }
    }
    ...
    public static <E extends Enum<E>> E readEnum(String pPrompt, E pEnum, boolean pNoCaseSensitive)
    {
        while (true)
        {
            ...
            {
                printPrompt(VALOR_INVALIDO + pEnum.getDeclaringClass().getSimpleName() + NEW_LINE);
                printPrompt(DIGITE_NOVAMENTE);
            }
        }
    }
